...
| Gravity ontology (_task_) | [27,28] | Describes gravity data types and processing methods for automatic contouring of gravity anomalies (i.e simple to complex Bouguer anomalies) | OWL | GEON |
**2007**
| EarthModel Ontology (_task_) | [29] | The EarthModel ontology describes the the spatio-temporal relationships between geologic objects, geologic events, geological models, and geological assemblages as a mechanism to describe entities like a *formation*; designed as a mechanism to integrate concepts currently relevant in reservoir modelling; an extension of [13] | - | Geo-ontology;<br /> Event Ontology |
| GeologicalEvent Ontology (_task_) | [30,29] | A general ontology of events applied to spatio-temporal reasoning in the geosciences; could be used to delineate sequences (i.e. diagenetic paragenesis) or automatic reconstruction of lithologic assemblages | - | Geo-ontology;<br /> PetroGrapher;<br /> *Petrology Ontology* |
...
| GravityWDO (_task_) | [27,32] | A gravity data processing ontology created using the WDO-It method which instantiates specifications from Model-Based Workflows (MBWs) to ontological components (OWL) | OWL | GEON; Gravity Ontology |
...
| [Ice of Land origin ontology](https://nsidc.org/ssiii/ontology.html) (_task_) | [52] | Part of "WMO ontologies"--based on WMO nomenclature; describes types of ice of land origin now found in the sea | OWL | Forms of Ice ontology |
| [Sea Ice Concentration ontology](https://nsidc.org/ssiii/ontology.html) (_task_) | [52] | Part of "WMO ontologies"--based on WMO nomenclature; describes concentration of ice now in the ocean | OWL | Sea Ice ontology |
...
**2008** <!-- [//]: # ( see Rainaud et al. 2008 for the next three from 63---double check; see also Mastella et al 2007 -- # 29 ) -->
