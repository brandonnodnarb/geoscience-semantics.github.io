# awesome ge0semantics
A curated list of geoscience semantic frameworks, ranging from CNLs to full logical models.

This work was inspired by [awesome-python](https://github.com/vinta/awesome-python). [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

- [Geoscience Semantic Models](#Geoscience-Semantic-Models)
(what is the best way to do this?   by domain?  by ontological category?  by language?)
    - [Dictionaries](#dictionaries)
    - [Glossaries](#glossaries)
    - [Term lists](#termlists)
    - [Thesauri](#thesauri)
    ...
    - [Logical Languages](#logicallanguages)
        - [Web Ontology Language](#OWL) (OWL)
        - [Knowledge Interchange Format](#KIF) (KIF)
        - [Common Logic Interchange Framework](#CLIF) (CLIF)

- [Geoscience frameworks utilising semantics]
...
### Term lists
*Lists of terms or vocabularies; primarily used for tagging.*
...
## Heavyweight Semantic Models
Logical Languages</br>
...
| schema name      | citation                                | brief synopsis                                       |
| ---------------- | --------------------------------------- | ---------------------------------------------------- |
| SWEET | (Raskin, 2006); (Raskin and Pan, 2005) | Upper-level domain |
| NADM-C1 | (NADM Steering Committee, 2004); (Richard, 2006) | Upper-level domain; Geologic Map |
| Geo-ontology | (Perrin et al., 2005) | Upper-level domain |
...
| Volcano Ontology | (Fox et al., 2007); (McGuinness et al., 2007b); (Sinha et al., 2007) | Volcanology |
| Plate-tectonics Ontology | (Fox et al., 2007); (McGuinness et al., 2007b); (Sinha et al., 2007) | Plate-tectonics |
| Petrology Ontology | (Shkotin et al., 2012) | Petrology |
| Petroleum Basin ontology | (Nimmagadda et al., 2007) | Seismology |
| HIS ontology | (Piasecki and Beran, 2009); (Beran and Piasecki, 2009) | Water resources |
| CUAHSI discovery ontology V1.0 | (Piasecki and Beran, 2009); (Beran and Piasecki, 2009) | Water resources |
...
| | (Abel et al., 2005); (Abel et al., 2004a) | Petrography |
...
| schema name      | citation                                | brief synopsis                                       |
| ---------------- | --------------------------------------- | ---------------------------------------------------- |
| Data and Ontology MAPPING (GEON) | (Lin and Ludäscher, 2004); (Lin and Ludäscher, 2003) | Data Integration |
...
Contributions are welcome! Please take a look at the [contribution guidelines](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md) first.
...
[//]: # (use MkDocs to publish to web?  http://www.mkdocs.org/ )
